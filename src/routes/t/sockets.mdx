...
export const title = "Sockets";
export const description = "Talking about sockets and file descriptors";
export const date = "2022-11-11";
export const tags = ["network", "tcp"];
