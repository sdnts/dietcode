...
export const title = "Cryptographic Signatures";
export const description = "What are signatures and what are they good for?";
export const date = "2022-11-14";
export const tags = ["network", "security", "tls"];

<Metadata {...{ title, description, date, tags }} />

# TIL: Cryptographic signatures
