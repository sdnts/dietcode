...
export const title = "Unicode normalization";
export const description =
  "How can two unicode characters look the same but mean different things?";
export const date = "2022-11-24";
export const tags = ["unicode"];

<Metadata {...{ title, description, date, tags }} />

# TIL: Unicode normalization
