...
export const title = "Vagrant";
export const description =
  "Vagrant lets you spin up pre-configured VMs on-demand. I figure out what I can do with this.";
export const date = "2022-12-12";
export const tags = ["devops", "vagrant"];
...
Vagrant also supports provisioners like [`Ansible`](https://www.ansible.com/) (TIL
about this coming soon!) that will let you configure your VM the way you please when
