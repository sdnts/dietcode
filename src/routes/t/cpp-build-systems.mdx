...
export const title = "The surprisingly complex world of C++ build systems";
export const description =
  "I've been meaning to dig into C++ for a bunch of reasons, and surprisingly, getting a development environment set up on macOS was really hard. I've now set up a template repository on GitHub for anyone looking for a shortcut.";
export const date = "2022-12-18";
export const tags = ["c++"];

<Metadata {...{ title, description, date, tags }} />

# TIL: The surprisingly complex world of C++ build systems
