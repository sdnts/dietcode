...
export const title = "Virtual Machines on the M1";
export const description =
  'I discovered what it takes to run VMs on an M1, especially because they don\'t "just work"';
export const date = "2022-12-13";
export const tags = ["devops", "vagrant", "qemu", "vm"];

<Metadata {...{ title, description, date, tags }} url={import.meta.url} />
