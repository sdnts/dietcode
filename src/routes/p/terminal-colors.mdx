...
![Output with no colors](/t/terminal-colors/simple.png)
...
![Output with an orange foreground color](/t/terminal-colors/fg-color.png)
...
![Output with an orange background color](/t/terminal-colors/bg-color.png)
...
![Output with a red text against an orange background](/t/terminal-colors/fg-bg-color.png)
...
![Output with a orange, bold text](/t/terminal-colors/underlined.png)
...
![Output of a terminal greeter](/t/terminal-colors/zfetch.png)
